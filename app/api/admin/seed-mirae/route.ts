// One-shot bootstrap: inserts the locally-parsed Mirae Asset bundle into
// amcs/funds/disclosures via the gateway. Hard-scoped to amc_slug: "mirae"
