...
// dbBulkInsert caps at 1000 rows/call (see lib/db.ts). SBI's bundle (100+ schemes x
// many months) doesn't fit in one call, so every bulk insert here is chunked, same
// as seed-hdfc/route.ts. Keep the chunk size comfortably under the 1000-row cap.
